...
/**
 * usagemonitorCollec subplugin info class.
 *
...
class usagemonitorcollec extends base {
    /**
    ...
    public static function get_enabled_plugins() {
        ...
        // we have two types of plugin : usagemonitorstats & usagemonitordata
        $plugins = core_plugin_manager::instance()->get_installed_plugins('usagemonitorcollec');
        if (!$plugins) {
            return array();
        }
        $installed = array();
        foreach ($plugins as $plugin => $version) {
            $installed[] = 'usagemonitorcollec_'.$plugin;
        }
